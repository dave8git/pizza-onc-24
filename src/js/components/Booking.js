...
class Booking {
    ...
    parseData(bookings, eventsCurrent, eventsRepeat) { // powinno być tak:     parseData(bookings, eventsCurrent, eventsRepeat) {
        const thisBooking = this; 
    ...
    makeBooked(date, hour, duration, table) {
        ...
        if(typeof thisBooking.booked[date] == 'undefined'){ // jeżeli nie mamy żadnej właściwości w thisBooking.booked to dodajemy wpis z datą 
            thisBooking.booked[date] = {}  // (inaczej nie zadziała dodanie wpisu np. do tablicy: thisBooking.booked[date][hour].push(table); więc najpierw musimy sobie sprawdzić.)
        }
